...
export default function App() {
  ...
  return (
    <div className="relative h-screen w-screen bg-[#030305]">
      ...
      {/* Mobile: Single frosted container */}
      <div className="absolute top-4 left-4 right-4 z-10 md:hidden bg-black/50 backdrop-blur-xl rounded-3xl p-5 space-y-4 max-h-[85vh] overflow-y-auto">
        <div>
          <h1 className="text-2xl font-semibold mb-1 text-white tracking-tight">
            formulaco2
          </h1>
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            <div className="text-xs font-medium uppercase tracking-widest text-zinc-500 mb-1">
              2024 Total
            </div>
            <div className="text-2xl font-semibold font-mono text-white tracking-tight">
              168,720
              <span className="text-xs text-zinc-500 ml-1 font-normal">tCO₂e</span>
            </div>
          </div>
          <div className="flex-1">
            <div className="text-xs font-medium uppercase tracking-widest text-zinc-500 mb-1">
            ...
            <div className="text-2xl font-semibold font-mono text-white tracking-tight">24</div>
          </div>
          <div className="flex-1">
            <div className="text-xs font-medium uppercase tracking-widest text-zinc-500 mb-1">
              vs 2018
            </div>
            <div className="text-2xl font-semibold font-mono text-emerald-400 tracking-tight">-26%</div>
          </div>
        </div>
        ...
        {selectedRace && emissions && (
          <>
            <div className="border-t border-white/10 pt-4">
              <div className="text-xs font-medium uppercase tracking-widest text-blue-400 mb-2">
                {selectedRace.country}
              </div>
              <div className="text-xl font-semibold text-white mb-2 leading-tight">
                {selectedRace.name}
              </div>
              <div className="text-sm text-zinc-400">{selectedRace.circuit}</div>
            ...
            <div className="border-t border-white/10 pt-4">
              ...
              <div className="text-3xl font-semibold font-mono text-white tracking-tight">
                {total.toLocaleString()}
                <span className="text-sm text-zinc-500 ml-2 font-normal">tCO₂e</span>
              </div>
            </div>
      ...
      <div className="hidden md:block absolute top-8 left-8 z-10 space-y-4 max-w-[300px]">
      ...
      {/* Desktop: Right floating cards - Selected race */}
      {selectedRace && emissions && (
        <div key={selectedRace.id} className="hidden md:block absolute top-8 right-8 z-10 space-y-4 max-w-[320px]">
      ...
      {/* Hint when no race selected - desktop only */}
      {!selectedRace && (
